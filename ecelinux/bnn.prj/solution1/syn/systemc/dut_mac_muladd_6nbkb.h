...
// ==============================================================
#ifndef __dut_mac_muladd_6nbkb__HH__
#define __dut_mac_muladd_6nbkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mac_muladd_6nbkb) {
    ...
    SC_CTOR(dut_mac_muladd_6nbkb):  simcore_mac_0_U ("simcore_mac_0_U") {
