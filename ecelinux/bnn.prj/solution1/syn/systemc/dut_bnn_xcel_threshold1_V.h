...
#ifndef __dut_bnn_xcel_threshold1_V_H__
#define __dut_bnn_xcel_threshold1_V_H__
...
struct dut_bnn_xcel_threshold1_V_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dut_bnn_xcel_threshold1_V_ram) {
...
SC_MODULE(dut_bnn_xcel_threshold1_V) {
...
dut_bnn_xcel_threshold1_V_ram* meminst;


SC_CTOR(dut_bnn_xcel_threshold1_V) {
meminst = new dut_bnn_xcel_threshold1_V_ram("dut_bnn_xcel_threshold1_V_ram");
