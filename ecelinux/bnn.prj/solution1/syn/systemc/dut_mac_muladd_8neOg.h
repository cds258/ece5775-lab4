...
// ==============================================================
#ifndef __dut_mac_muladd_8neOg__HH__
#define __dut_mac_muladd_8neOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mac_muladd_8neOg) {
    ...
    SC_CTOR(dut_mac_muladd_8neOg):  simcore_mac_3_U ("simcore_mac_3_U") {
