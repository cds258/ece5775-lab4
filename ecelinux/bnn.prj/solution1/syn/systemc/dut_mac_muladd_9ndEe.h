...
// ==============================================================
#ifndef __dut_mac_muladd_9ndEe__HH__
#define __dut_mac_muladd_9ndEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mac_muladd_9ndEe) {
    ...
    SC_CTOR(dut_mac_muladd_9ndEe):  simcore_mac_2_U ("simcore_mac_2_U") {
