...
// ==============================================================
#ifndef __dut_fcmp_32ns_32nlbW__HH__
#define __dut_fcmp_32ns_32nlbW__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_fcmp_32ns_32nlbW) {
    ...
    SC_CTOR(dut_fcmp_32ns_32nlbW):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
