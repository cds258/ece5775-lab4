...
// ==============================================================
#ifndef __dut_mac_muladd_6nfYi__HH__
#define __dut_mac_muladd_6nfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mac_muladd_6nfYi) {
    ...
    SC_CTOR(dut_mac_muladd_6nfYi):  simcore_mac_4_U ("simcore_mac_4_U") {
