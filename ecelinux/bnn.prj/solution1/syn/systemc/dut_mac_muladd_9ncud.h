...
// ==============================================================
#ifndef __dut_mac_muladd_9ncud__HH__
#define __dut_mac_muladd_9ncud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_mac_muladd_9ncud) {
    ...
    SC_CTOR(dut_mac_muladd_9ncud):  simcore_mac_1_U ("simcore_mac_1_U") {
