...
// ==============================================================
#ifndef __dut_sitofp_32ns_3kbM__HH__
#define __dut_sitofp_32ns_3kbM__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_sitofp_32ns_3kbM) {
    ...
    SC_CTOR(dut_sitofp_32ns_3kbM):  ACMP_sitofp_U ("ACMP_sitofp_U") {
